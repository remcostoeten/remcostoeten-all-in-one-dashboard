        ...
        <div className='container mx-auto px-4 py-10'>
            <header className='text-center'>
                <h1 className='text-4xl font-bold text-gray-800'>
                    🚀 Personal All-in-One Panel Roadmap
                </h1>
                ...
                <p className='text-sm text-gray-500 mt-1'>
                    ...
                    built over so it's far from done. And probably never will
                    be.
                </p>
            </header>
            ...
            <main>
                ...
                <section className='my-10'>
                    ...
                    <ul className='list-disc pl-5 space-y-2'>
                        <li>
                            <a
                                href='https://www.hover.dev/templates/demo/the-startup'
                        ...
                        <li>
                            <a
                                href='https://vercel.com/blog/deploy-summary'
                                className='text-blue-500 hover:underline'
                            >
                ...
                <section className='my-10'>
                    ...
                    <ul className='list-disc pl-5 space-y-2'>
                        <li>
                            Spark effect{' '}
                            <a
                                href='https://codepen.io/hexagoncircle/details/bGZdWyw'
                                className='text-blue-500 hover:underline'
                            >
                                [source]
                            </a>
                        ...
                        <li>
                            Dark glow button{' '}
                            <a
                                href='https://codepen.io/collinsworth/pen/zYepgqG'
                                className='text-blue-500 hover:underline'
                            >
                                [source]
                            </a>
                        ...
                        <li>
                            Glow card{' '}
                            <a
                                href='https://codepen.io/jh3y/pen/MWxgJXY'
                                className='text-blue-500 hover:underline'
                            >
                                [source]
                            </a>
                        ...
                        <li>
                            Menu animation{' '}
                            <a
                                href='https://codepen.io/jh3y/pen/GRapZqO'
                                className='text-blue-500 hover:underline'
                            >
                                [source]
                            </a>
                        ...
                        <li>
                            Card anchor effect{' '}
                            <a
                                href='https://codepen.io/jh3y/pen/MWLyGxo'
                                className='text-blue-500 hover:underline'
                            >
                                [source]
                            </a>
