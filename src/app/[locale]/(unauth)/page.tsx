...
const Section = ({ children, spacingY =
  '0', ...props }: {spacingY: '0' | 'regular' | 'big' | 'xl', children: ReactNode }) => {
  let spacingClass = '';
  switch (spacingY) {
      case '0':
          spacingClass = 'my-0';
...
function IosNotesIcon() {
  return (
    <svg className='sr-hidden absolute -right-[400px] top-0 opacity-0 pointer-events-none' xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="120" height="120" viewBox="0 0 120 120">
    <defs>
      <linearGradient id="e" x1="50%" x2="50%" y1="0%" y2="100%">
        <stop offset="0%" stopColor="#F4D87E"></stop>
        <stop offset="100%" stopColor="#F5C52C"></stop>
      </linearGradient>
      <filter id="c" width="110.2%" height="146.7%" x="-5.1%" y="-16.7%" filterUnits="objectBoundingBox">
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <path fill="#C7C5C9" d="M0 59h120v2H0zM0 89h120v2H0z" mask="url(#b)"></path>
