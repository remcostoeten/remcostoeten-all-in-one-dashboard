...
} from '@/core/utils/favourite-colors'
...
export default function ColorConverter() {
    ...
    const handleRgbChange = (newRgbColor: {
        r: number
        g: number
        b: number
    }) => {
    ...
    const handleHslChange = (newHslColor: {
        h: number
        s: number
        l: number
    }) => {
        setHslColor(newHslColor)
        const newRgbColor = hslToRgb(
            newHslColor.h,
            newHslColor.s,
            newHslColor.l
        )
    ...
    const handleRgbaChange = (newRgbaColor: {
        r: number
        g: number
        b: number
        a: number
    ...
    return (
        <div className='min-h-screen '>
            <div className='max-w-4xl mx-auto rounded-xl shadow-md overflow-hidden'>
                ...
                <div className='space-y-4'>
                    <ColorInput
                        size='large'
                        label='HEX'
                        value={parseInt(hexColor.slice(1), 16)}
                        onChange={(value) =>
                            handleHexChange(
                    ...
                    <ColorInput
                        ...
                        value={hslColor.h}
                        onChange={(value) =>
                            handleHslChange({ ...hslColor, h: value })
                        }
                    />
                    <ColorInput
                        label='S'
                        value={hslColor.s}
                        onChange={(value) =>
                            handleHslChange({ ...hslColor, s: value })
                        }
                    />
                    <ColorInput
                        label='L'
                        value={hslColor.l}
                        onChange={(value) =>
                            handleHslChange({ ...hslColor, l: value })
                        }
                    />
                    <ColorInput
                        label='A'
                        value={rgbaColor.a}
                        onChange={(value) =>
                            handleRgbaChange({ ...rgbaColor, a: value })
                        }
                    />
                </div>
            </div>
            ...
            <div className='mt-8'>
                ...
                <p className='text-lg'>
                    Contrast Ratio:{' '}
                    <span className='font-semibold'>{contrastRatio}</span>
                </p>
            </div>
