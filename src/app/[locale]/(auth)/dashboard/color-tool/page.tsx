...
import ColorInput from "./components/ColorSlider";
    ...
    return (
        <div className="min-h-screen ">
            <div className="max-w-4xl mx-auto rounded-xl shadow-md overflow-hidden">
                <div className="p-8">
                    <h1 className="text-3xl font-boldmb-6">Color Converter</h1>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-4">
                            <ColorInput label="R" value={rgbColor.r} onChange={(value) => handleRgbChange({ ...rgbColor, r: value })} />
                            <ColorInput label="G" value={rgbColor.g} onChange={(value) => handleRgbChange({ ...rgbColor, g: value })} />
                            <ColorInput label="B" value={rgbColor.b} onChange={(value) => handleRgbChange({ ...rgbColor, b: value })} />
                            <ColorSliders color={rgbColor} onChange={handleRgbChange} />
                        </div>

                        <div className="space-y-4">
                            <ColorInput label="HEX" value={parseInt(hexColor.slice(1), 16)} onChange={(value) => handleHexChange(`#${value.toString(16).padStart(6, "0")}`)} />
