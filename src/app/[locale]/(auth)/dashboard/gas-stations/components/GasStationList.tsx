...
const GasStationList = ({ stations }: { stations: GasStation[] }) => {
    return (
        <section
            className='bg-background-main text-text-primary p-6 rounded-lg shadow-lg'
            aria-labelledby='gas-stations-title'
        >
            <h2 id='gas-stations-title' className='text-2xl font-semibold mb-4'>
                Gas Stations
            </h2>
            <div className='overflow-x-auto'>
                <table
                    className='w-full table-auto'
                    aria-describedby='gas-stations-title'
                >
                    <TableHeader />
                    <tbody>
