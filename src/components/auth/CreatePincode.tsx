...
import { Dialog, DialogTrigger, DialogContent, DialogHeader, Button, DialogTitle, DialogDescription, Label } from "../ui";
        ...
        <Dialog>
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Let's get started by setting up your 6-character pincode.
                    </DialogDescription>
                </DialogHeader>
                <form>
                    <Label htmlFor="pincode">Enter your 6-character pincode</Label>
                    <InputOTP
                        maxLength={6}
                        name="pincode"
                        render={({ slots }) => (
