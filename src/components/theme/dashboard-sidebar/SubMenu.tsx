...
import { RenderChatsList } from './RenderChatsList.server'
import { IndividualChatSkeleton } from '@/components/effects/SkeletonLoaders'
...
function SubMenu() {
    return (
        <div className='flex flex-col w-full max-w-[240px] bg-sidebar text-text-primary border-r border-border'>
            ...
            <Suspense fallback={<IndividualChatSkeleton />}>
                <RenderChatsList />
            </Suspense>
