        ...
        return (
            ...
            >
                <PopoverTrigger asChild>
                    <button className='!m-0 hover:border-icon-active-background  gap-1.5 flex items-center justify-center px-3 py-0.5 mt-7 text-xs text-center whitespace-nowrap rounded-md border border-solid !bg-icon-ghost-hover text-white h-max border-ghost hover:border-ghost-hover  border-transition  bg-ghost-hover !px-4 py-1.5   transition-all duration-300' >
                        <div className='text-right'>
                            <div className='py-1'>
                                <div>{`${formatDate(range.from, locale)}${range.to != null
