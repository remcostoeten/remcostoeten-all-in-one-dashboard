...
export function FavouriteChatMessage({ messageId, userId, chatBetween, children }) {
            ...
            <DropdownMenuContent>
                ...
                <DropdownMenuGroup>
                    <DropdownMenuItem onClick={handleFavorite}>
                        <HeartIcon className={`mr-2 h-4 w-4 ${isFavorited ? 'text-red-500' : ''}`} />
                        {isFavorited ? 'Unfavorite message' : 'Favorite message'}
                    </DropdownMenuItem>
