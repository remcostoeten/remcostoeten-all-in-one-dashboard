...
var db_models_1 = require("src/core/db-models");
                ...
                case 0:
                    ...
                    for (i = 0; i < 10; i++) {
                        todos.push({
                            ...
                            link: "http://example.com/task".concat(i + 1),
                            description: "Description for task ".concat(i + 1),
                            completed: Math.round(Math.random()), // random boolean value 0 or 1
                        });
                    }
                    return [4 /*yield*/, db.insert(db_models_1.todoSchema).values(todos)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
